...
Define the stable cookie-authenticated PC crawling facade used by external projects such as RedNote2TG to consume Spider_XHS without depending on script entry points or login flows.
